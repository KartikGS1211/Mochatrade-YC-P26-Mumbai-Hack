...
export const INITIAL_PORTFOLIO: Portfolio = {
  ...
  openPositions: 3,
  dataWindow: "90 days",
  dataTimestamp: new Date("2026-09-10").toISOString(),
...
export const DEFAULT_RISK_ANALYSIS: RiskAnalysisResult = {
  ...
  alertStatement: "This order materially increases correlated technology exposure. Calculated from verified market inputs.",
  ...
  components: [
    ...
    },
    {
      ...
      before: 55, after: 81, delta: 26,
      description: "NVDA exhibits a 0.82 pairwise correlation with your existing AMD holding.",
      tooltip: "Calculated from verified market inputs over a 90-day rolling lookback.",
    },
    {
      component: "Leverage",
      before: 48, after: 76, delta: 28,
